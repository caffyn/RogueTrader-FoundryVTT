export default class EffectScriptConfig extends FormApplication {
    ...
    static get defaultOptions() {
        return mergeObject(super.defaultOptions, {
            ...
            template: "systems/rogue-trader/template/apps/effect-script.html",
            height: 400,
            width: 500,
    ...
    _updateObject(event, formData) {
        ...
        return this.object.effect.update({[`flags.rogue-trader.changeCondition.${this.object.index}`] : {script, description}})
    }
} 